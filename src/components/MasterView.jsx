...
export function MasterView({ receiptResult, billsResult }) {
  const { list, stats } = computePatientLedgerMaster(receiptResult, billsResult);
    ...
    <div className="view">
      <header className="view-head">
        ...
        <p className="lede">
          ...
          the Receipts and Bills you've loaded. Download once and import into
          Tally so every voucher's Party posts to an existing ledger.
        </p>
      </header>
      ...
      {!anyData ? (
        ...
        <>
          <section className="card">
            ...
            <StatRow label="Appear in both Receipts and Bills" value={stats.inBoth.toLocaleString()} />
            <StatRow label="Only in Receipts" value={stats.onlyReceipts.toLocaleString()} />
            <StatRow label="Only in Bills" value={stats.onlyBills.toLocaleString()} />
